...
\code{time rX}       & \code{00001001 00000000 00000000 0000XXXX} & sets \code{rX} to the time since midnight \grule
...
\begin{tabularx}{\columnwidth}{lll}
Opcode & 32-bit Machine Code & Description \brule 
\code{addi rX rY rZ}  & \code{00010000 00000000 0000XXXX YYYYZZZZ} & sets \code{rX = rY + rZ} for integers \grule
\code{subi  rX rY rZ}  & \code{00010001 00000000 0000XXXX YYYYZZZZ} & sets \code{rX = rY - rZ} for integers \grule
\code{muli  rX rY rZ}  & \code{00010010 00000000 0000XXXX YYYYZZZZ} & sets \code{rX = rY * rZ} for integers \grule
\code{divi  rX rY rZ}  & \code{00010011 00000000 0000XXXX YYYYZZZZ} & sets \code{rX = rY // rZ} for integers \grule
\code{modi  rX rY rZ}  & \code{00010100 00000000 0000XXXX YYYYZZZZ} & sets \code{rX = rY \% rZ} for integers \grule
\code{negi  rX rY}     & \code{00010101 00000000 00000000 XXXXYYYY} & sets \code{rX = -rY} for integers \grule
\code{addf rX rY rZ} & \code{00010110 00000000 0000XXXX YYYYZZZZ} & sets \code{rX = rY + rZ} for floating point numbers \grule
\code{subf rX rY rZ} & \code{00010111 00000000 0000XXXX YYYYZZZZ} & sets \code{rX = rY - rZ} for floating point numbers \grule
\code{mulf rX rY rZ} & \code{00011000 00000000 0000XXXX YYYYZZZZ} & sets \code{rX = rY * rZ} for floating point numbers \grule
\code{divf rX rY rZ} & \code{00011001 00000000 0000XXXX YYYYZZZZ} & sets \code{rX = rY // rZ} for floating point numbers \grule
\code{negf rX rY}    & \code{00011010 00000000 00000000 XXXXYYYY} & sets \code{rX = -rY} for floating point numbers
\end{tabularx}
\end{boundedbox}
...
\begin{tabularx}{\columnwidth}{lll}
Opcode & 32-bit Machine Code & Description \brule 
\code{jump N}      & \code{00110000 00000000 NNNNNNNN NNNNNNNN} & jumps to instruction \code{N} \grule
\code{jra rX}     & \code{00110001 00000000 00000000 0000XXXX} & jumps to instruction \code{rX} \grule
\code{jeqz rX N}   & \code{00110010 0000XXXX NNNNNNNN NNNNNNNN} & jumps to instruction \code{N} if \code{rX == 0} \grule
\code{jnez rX N}   & \code{00110011 0000XXXX NNNNNNNN NNNNNNNN} & jumps to instruction \code{N} if \code{rX != 0} \grule
\code{jge rX rY N} & \code{00110100 XXXXYYYY NNNNNNNN NNNNNNNN} & jumps to instruction \code{N} if \code{rX >= rY} \grule
\code{jle rX rY N} & \code{00110101 XXXXYYYY NNNNNNNN NNNNNNNN} & jumps to instruction \code{N} if \code{rX <= rY} \grule
\code{jeq rX rY N} & \code{00110110 XXXXYYYY NNNNNNNN NNNNNNNN} & jumps to instruction \code{N} if \code{rX == rY} \grule
\code{jne rX rY N} & \code{00110111 XXXXYYYY NNNNNNNN NNNNNNNN} & jumps to instruction \code{N} if \code{rX != rY} \grule
\code{jgt rX rY N} & \code{00111000 XXXXYYYY NNNNNNNN NNNNNNNN} & jumps to instruction \code{N} if \code{rX > rY} \grule
\code{jlt rX rY N} & \code{00111001 XXXXYYYY NNNNNNNN NNNNNNNN} & jumps to instruction \code{N} if \code{rX < rY} \grule
\code{jsr rX N}   & \code{00111010 0000XXXX NNNNNNNN NNNNNNNN} & sets \code{rX = pc + 1} and jumps to instruction \code{N}
\end{tabularx}
\end{boundedbox}
...
\code{inci rX N}  & \code{01000001 0000XXXX NNNNNNNN NNNNNNNN} & sets \code{rX = rX + N}, where \code{N} $\in [-2^{15}, 2^{15}-1]$ \grule
\code{setf rX F}  & \code{01000010 0000XXXX FFFFFFFF FFFFFFFF} & sets \code{rX = F}, where \code{F} is a floating point number \grule
\code{incf rX F}  & \code{01000011 0000XXXX FFFFFFFF FFFFFFFF} & sets \code{rX = rX + F}, where \code{F} is a floating point number  \grule
...
% push/pop byte
\code{pushb rX rY}    & \code{01010000 00000000 00000000 XXXXYYYY} & sets \code{mem[rY--] = rX} \grule
\code{popb rX rY}     & \code{01010001 00000000 00000000 XXXXYYYY} & sets \code{rX = mem[++rY]} \grule
% push/pop short
\code{pushs rX rY}    & \code{01010010 00000000 00000000 XXXXYYYY} & sets \code{mem[rY--] = rX} \grule
\code{pops rX rY}     & \code{01010011 00000000 00000000 XXXXYYYY} & sets \code{rX = mem[++rY]} \grule
% push/pop word
\code{pushw rX rY}    & \code{01010100 00000000 00000000 XXXXYYYY} & sets \code{mem[rY--] = rX} \grule
\code{popw rX rY}     & \code{01010101 00000000 00000000 XXXXYYYY} & sets \code{rX = mem[++rY]}
\end{tabularx}
\end{boundedbox}

\noindent Instructions for interacting with stack memory (starting with the nibble \code{0110}):
...
Opcode & 32-bit Machine Code & Description \brule 
% TODO: descriptions
\code{ldbn rX rY N}  & \code{01100000 XXXXYYYY NNNNNNNN NNNNNNNN} & sets \code{rX = mem[rY - N]}, ... \grule
\code{ldsn rX rY N}  & \code{01100001 XXXXYYYY NNNNNNNN NNNNNNNN} & sets \code{rX = mem[rY - N : rY - N - 2]}, ... \grule
\code{ldwn rX rY N}  & \code{01100010 XXXXYYYY NNNNNNNN NNNNNNNN} & sets \code{rX = mem[rY - N : rY - N - 4]}, ... \grule
\code{stbn rX rY N}  & \code{01100011 XXXXYYYY NNNNNNNN NNNNNNNN} & sets \code{mem[rY - N] = rX}, ... \grule
\code{stsn rX rY N}  & \code{01100100 XXXXYYYY NNNNNNNN NNNNNNNN} & sets \code{mem[rY - N : rY - N - 2] = rX}, ... \grule
\code{stwn rX rY N}  & \code{01100101 XXXXYYYY NNNNNNNN NNNNNNNN} & sets \code{mem[rY - N : rY - N - 4] = rX}, ... \grule
\code{ldbr rX rY}    & \code{01100110 00000000 00000000 XXXXYYYY} & sets \code{rX = mem[rY]}, ... \grule
\code{ldsr rX rY}    & \code{01100111 00000000 00000000 XXXXYYYY} & sets \code{rX = mem[rY : rY - 2]}, ... \grule
\code{ldwr rX rY}    & \code{01101000 00000000 00000000 XXXXYYYY} & sets \code{rX = mem[rY : rY - 4]}, ...\grule
\code{stbr rX rY}    & \code{01101001 00000000 00000000 XXXXYYYY} & sets \code{mem[rY] = rX}, ... \grule
\code{stsr rX rY}    & \code{01101010 00000000 00000000 XXXXYYYY} & sets \code{mem[rY : rY - 2] = rX}, ...\grule
\code{stwr rX rY}    & \code{01101011 00000000 00000000 XXXXYYYY} & sets \code{mem[rY : rY - 4] = rX}, ...
\end{tabularx}
\end{boundedbox}

\bigskip

\noindent Instructions for interacting with heap memory (starting with the nibble \code{0111}):
...
\code{ldba rX A}  & \code{01110000 0000XXXX AAAAAAAA AAAAAAAA} & sets \code{rX = mem[A]}, ... \grule
\code{ldsa rX A}  & \code{01110001 0000XXXX AAAAAAAA AAAAAAAA} & sets \code{rX = mem[A : A + 2]}, ... \grule
\code{ldwa rX A}  & \code{01110010 0000XXXX AAAAAAAA AAAAAAAA} & sets \code{rX = mem[A : A + 4]}, ... \grule
\code{stba rX A}  & \code{01110011 0000XXXX AAAAAAAA AAAAAAAA} & sets \code{mem[A] = rX}, ... \grule
\code{stsa rX A}  & \code{01110100 0000XXXX AAAAAAAA AAAAAAAA} & sets \code{mem[A : A + 2] = rX}, ... \grule
\code{stwa rX A}  & \code{01110101 0000XXXX AAAAAAAA AAAAAAAA} & sets \code{mem[A : A + 4] = rX}, ...
\end{tabularx}
\end{boundedbox}
...
.text
     ...
     seti     r1 0        # zero = 0
loop:
     jlt      r0 r1 done  # if n < zero jump to done
     writei   r0          # write n
     inci     r0 -1       # n = n - 1
...
\begin{window}[\tilde/workspace/marvin]
\begin{codeblock}[]{{}}
$ python3 marvin.py Countdown.marv
5
5
4
3
