...
\begin{document}
\noindent Marvin is a hypothetical computer with sixteen 32-bit registers and 65,536 32-bit words of main memory (aka RAM). In addition to the sixteen registers, Marvin has a 16-bit program counter \code{pc} and a 32-bit instruction register \code{ir}. 
