...
\code{ldbn rX rY N}  & \code{01100000 XXXXYYYY NNNNNNNN NNNNNNNN} & sets \code{rX = mem[rY + N]}, where \code{N} $\in [-2^{15}, 2^{15}-1]$ \grule
\code{stbn rX rY N} & \code{01100001 XXXXYYYY NNNNNNNN NNNNNNNN} & sets \code{mem[rY + N] = rX}, where \code{N} $\in [-2^{15}, 2^{15}-1]$ \grule
\code{ldbr rX rY}    & \code{01100010 00000000 00000000 XXXXYYYY} & sets \code{rX = mem[rY]} \grule
\code{stbr rX rY}   & \code{01100011 00000000 00000000 XXXXYYYY} & sets \code{mem[rY] = rX} \grule
% loads/stores for short
\code{ldsn rX rY N}  & \code{01100100 XXXXYYYY NNNNNNNN NNNNNNNN} & sets \code{rX = mem[rY + N]}, where \code{N} $\in [-2^{15}, 2^{15}-1]$ \grule
\code{stsn rX rY N} & \code{01100101 XXXXYYYY NNNNNNNN NNNNNNNN} & sets \code{mem[rY + N] = rX}, where \code{N} $\in [-2^{15}, 2^{15}-1]$ \grule
\code{ldsr rX rY}    & \code{01100110 00000000 00000000 XXXXYYYY} & sets \code{rX = mem[rY]} \grule
\code{stsr rX rY}   & \code{01100111 00000000 00000000 XXXXYYYY} & sets \code{mem[rY] = rX} \grule
% loads/stores for word
\code{ldwn rX rY N}  & \code{01101000 XXXXYYYY NNNNNNNN NNNNNNNN} & sets \code{rX = mem[rY + N]}, where \code{N} $\in [-2^{15}, 2^{15}-1]$ \grule
\code{stwn rX rY N} & \code{01101001 XXXXYYYY NNNNNNNN NNNNNNNN} & sets \code{mem[rY + N] = rX}, where \code{N} $\in [-2^{15}, 2^{15}-1]$ \grule
\code{ldwr rX rY}    & \code{01101010 00000000 00000000 XXXXYYYY} & sets \code{rX = mem[rY]} \grule
\code{stwr rX rY}   & \code{01101011 00000000 00000000 XXXXYYYY} & sets \code{mem[rY] = rX}
\end{tabularx}
\end{boundedbox}
